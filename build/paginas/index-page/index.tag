...
<style >
  ...
  .flex_item--card[data-z="181"]{
    background-color:rgb(64, 61, 49)!important;

  }
  .flex_item--card[data-z="182"]{
    background-color:rgb(75, 161, 119)!important;
  ...
  .grid-container[data-dato="triple"]{
    grid-template-columns:repeat(3, 30vw);
  }

</style>

<button type="button" name="button" onclick={ doSingle }>single</button>
<button type="button" name="button" onclick={ doSplit }>split</button>
<button type="button" name="button" onclick={ doTriple }>triple</button>
...
<div class="grid-container" data-dato={ cualquieres }>
    <div each={ x in cards } class="flex_item--card" data-z={ x.id }>
...
<hr>
<button type="button" name="button" onclick={ verCodigo }>VerCodigo</button>
