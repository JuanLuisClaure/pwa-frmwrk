...
(function () {
  ...
  d = function d(a, b) {
    ...
    for (c = a, h = b.split("."), d = e = 0, f = h.length; f > e && (g = h[d], c = c[g], "object" == _typeof(c)); d = ++e) {}
  ...
  d = Offline.reconnect = {}, f = null, e = function e() {
    var a;
  ...
  c = [], f = !1, d = function d(a) {
    ...
    return Offline.getOption("requests") !== !1 ? (Offline.on("confirmed-up", function () {
      ...
      var b, c, e, f, g;
      return g = a.xhr, e = a.async, g.offline !== !1 && (f = function f() {
        return d(a);
  ...
  b = '<div class="offline-ui"><div class="offline-ui-content"></div></div>', a = '<a href class="offline-ui-retry"></a>', f = function f(a) {
    var b;
    ...
    var c, h;
    return g = f(b), document.body.appendChild(g), null != Offline.reconnect && Offline.getOption("reconnect") && (g.appendChild(f(a)), c = g.querySelector(".offline-ui-retry"), h = function h(a) {
  ...
  }, "complete" === document.readyState ? j() : null != document.addEventListener ? document.addEventListener("DOMContentLoaded", j, !1, {
    passive: true
  }) : (c = document.onreadystatechange, document.onreadystatechange = function () {
